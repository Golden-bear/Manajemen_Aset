            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-striped">
                ...
                <?php
                  ...
                  <a class='btn btn-danger' data-toggle='modal' href='#myModal' onclick="set_url('<?php echo "delete_asset.php?id=".$data['id_detail']."&&jenis=".$data['id_jenis']."&&unit=".$data['id_unit']."&&inv=".$data['id_inv']."&&lok=".$data['id_lokasi']."&&license=".$data['id_license']."&&app=".$data['id_app']."&&user=".$data['id_user'].";" ?>');">Delete</a><p></p>
                  <?php
                   echo"<a class='btn btn-success' href='histori_asset.php?id=".$data['id_detail']."'>Lihat Historical</a></td>";
        					echo "</tr>";
        				  }
                  else
                  {
                    echo "<td style='text-align:center;'><a class='btn btn-success' href='histori_asset.php?id=".$data['id_detail']."'>Lihat Historical</a></td>";
                  echo "</tr>";
                  }
                }
        				?>
