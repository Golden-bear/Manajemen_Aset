...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="content-wrapper">
    <section class="content-header">
      <h1> Form Tambah Lokasi Asset</h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
           <form method="post" action="simpan_lokasi.php" enctype="multipart/form-data" role="form">
          <div class="form-group">
            <label> Nama Lokasi</label>
            <input type="text" name="lokasi" class="form-control" required placeholder="Enter ...">
          </div>
